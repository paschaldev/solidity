...
# boost_filesystem_bug specifically tests a local
# fix for a boost::filesystem bug. Since the test
# involves a malformed path, there is no point in
# running AST tests on it.
